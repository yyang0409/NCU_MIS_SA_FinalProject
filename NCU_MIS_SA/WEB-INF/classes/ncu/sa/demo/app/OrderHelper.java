...
public class OrderHelper {
    ...
    public JSONObject create(Order order) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "INSERT INTO `missa`.`orders`(`member_name`, `payment_type`, `email`, `address`, `phone`)"
                    + " VALUES(?, ?, ?, ?, ?)";
            ...
            if (rs.next()) {
                id = rs.getLong(1);
                ArrayList<OrderItem> opd = order.getOrderProposalOption();
        ...
        response.put("order_proposaloption_id", opa);
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                o = new Order(order_id, member_name, payment_type ,email, address, phone );
    ...
    public JSONObject getById(String order_id) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `missa`.`orders` WHERE `orders`.`order_id` = ?";
            ...
            while(rs.next()) {
                ...
                o = new Order(id, member_name, payment_type, email, address, phone );
                /** 取出該項商品之資料並封裝至 JSONsonArray 內 */
    ...
    public JSONObject deleteById(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `missa`.`order` WHERE `order_id` = ? LIMIT 1";
