...
public class JsonReader {
     ...
     */
    public JsonReader(HttpServletRequest request) throws IOException, UnsupportedEncodingException,JSONException {
    ...
    public String getParameter(String key) {
    	...
    	System.out.println("JSON getParameter:"+this.request.getParameter(key));
